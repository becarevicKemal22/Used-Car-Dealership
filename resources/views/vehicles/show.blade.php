...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row mt-2 gx-5">
            <div class="col-md-6">
                <img class="mt-2 rounded" src="{{ $thumbnail }}" alt="Vehicle picture"
                        ...
                        @for ($i = 0; $i < 3; $i++)
                            <div style="position: relative;">
                                <img src="{{ $imagePaths[$i] }}" alt=""
                                     style="max-height: 9rem; width: auto; cursor:pointer;"
                                     class="vehicleImage rounded">
                                @if ($i == 2)
            ...
            <div class="col-md-6 mt-5 pi-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    @if ($vehicle->discount_price != null && $vehicle->discount_price > 0)
                        <div class="d-flex flex-column align-items-start gap-0">
                            <strike>
                                <h5 class="bold-text"
                                    style="margin-bottom: 0;">{{ number_format($vehicle->price, 0) . ' €' }}</h5>
                            </strike>
                            <h3 class="bold-text"><i class="fa-solid fa-money-bill-wave"
                                                     style="padding-right: 0.5em;"></i>{{ number_format($vehicle->discount_price, 0) . ' €' }}
                            </h3>
                        </div>
                    @else
                        <h3 class="bold-text"><i class="fa-solid fa-money-bill-wave"
                                                 style="padding-right: 0.5em;"></i>{{ number_format($vehicle->price, 0) . ' €' }}
                        </h3>
                    @endif
                    <h3 class="bold-text"><i
                            class="fa-solid fa-gauge-simple"></i> {{ number_format($vehicle->kilometers, 0). 'km' }}
                    </h3>
                </div>
                ...
                <div class="d-flex flex-column justify-content-center align-items-center mt-3">
                    <h3 class="text-bold text-center">Have a question regarding the car?</h3>
                    <div class="d-flex justify-content-center gap-4 mt-1">
                        <a href="tel:+38760220205" style="font-size: 2.4em;"><i class="fa-solid fa-phone"></i></a>
                        <a href="https://instagram.com" style="font-size: 2.5em"><i class="fa-brands fa-instagram"></i></a>
                        <a href="https://facebook.com" style="font-size: 2.5em"><i
        ...
        <div class="row">
            <div class="col-12 mt-5">
                <h3 class="bold-text">VEHICLE DESCRIPTION</h3>
                <p style="font-size: 1rem;" class="p-1">{{ $vehicle->opis }}</p>
            </div>
            <div class="col-12 mt-5">
                <h3 class="bold-text">VEHICLE EQUIPMENT</h3>
        ...
        @if (count($latest) >= 2)
            <div class="row mt-4">
                <h3 class="text-center mt-4 mb-4 bold-text">Latest in offer</h3>
                <div class="col-12">
